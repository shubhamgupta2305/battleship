...
public class GameWindow {
    ...
    private void displayGui() {
        ...
        messageHits = new JLabel("Number of Hits: " + hit);
        messageHits.setHorizontalAlignment(JLabel.RIGHT);
        messagePanel.add(messageHits, BorderLayout.NORTH);
        messageHits.setFont(new Font("Dialog", Font.PLAIN, 16));
    ...
    /*
     * Displays the number of ships hit.
     */

    public void hitsMessage(String msg){
        if(msg.equals("HIT!")){
            hit++;
            messageHits.setText("Number of hits: " + hit);
        }
